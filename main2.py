...
ROAD = [[[1080, 110, -5, 0, 0], [320, 110, 3, 5, 1], [500, 410, -4, 5, 1], [436, 490, -3, -1, 0],
        ...
        [[1080, 250, -5, 0, 0], [380, 250, 3, 4, 1], [500, 410, -4, 5, 1], [436, 490, -3, -1, 0],
         [49, 361, 0, 0, 0], [50, 362]]]
COOR_BUILD = [(250, 140), (360, 65), (500, 220), (650, 215), (575, 375), (250, 550), (220, 370),
              (310, 390)]
pygame.init()
...
class Tower_and_build(pygame.sprite.Sprite):
    ...
    image_move_1 = pygame.transform.scale(image_move_1, (75, 75))
    ...
    image_move_2 = pygame.transform.scale(image_move_2, (75, 75))
    ...
    image_move_3 = pygame.transform.scale(image_move_3, (75, 75))
    image4 = load_image("tower_and_build/towerkiano.png")
    image4 = pygame.transform.scale(image4, (75, 150))
    images = [image, image2, image3, image_move_1, image_move_2, image_move_3, image4]
